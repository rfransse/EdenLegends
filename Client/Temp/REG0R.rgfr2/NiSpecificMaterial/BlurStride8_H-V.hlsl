#line 2 "D:\EdenClients\DepotContainer\EdenWorking-\Client\Temp\REG0R.rgfr2\NiSpecificMaterial\BlurStride8_H-V.hlsl"
#ifdef D3D10
#undef D3D10
#endif
//---------------------------------------------------------------------------
...
void BlurStride8VSH(float4x4 Proj,
    float3 Input,
    float2 TexCoord,
    float4 Mask,
    float Offset0,
...
Output Main(Input In)
{
    Output Out;
	// Function call #0
    BlurStride8VSH(g_Proj, In.Position, In.UVSet, float4(-1.0, 0.0, 0.0, 1.0), 
